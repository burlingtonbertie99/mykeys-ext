...
# Get release
wget https://github.com/burlingtonbertie99/mykeys-ext/releases/download/v${ver}/keys_${ver}_linux_i386.deb
wget https://github.com/burlingtonbertie99/mykeys-ext/releases/download/v${ver}/keys_${ver}_linux_amd64.deb
# wget https://github.com/burlingtonbertie99/mykeys-ext/releases/download/v${ver}/keys_${ver}_linux_armv6.deb
