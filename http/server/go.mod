...
require (
	...
	github.com/burlingtonbertie99/mykeys-ext/firestore v0.0.0-20210523201126-199b37b87949
	github.com/burlingtonbertie99/mykeys-ext/http/api v0.0.0-20210525002154-62c1010a2830
