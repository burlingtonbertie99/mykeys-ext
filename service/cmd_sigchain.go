			...
			Subcommands: []cli.Command{
				{
					...
					Action: func(c *cli.Context) error {
						...
						seq := c.Int("seq")
						if seq != 0 {
							resp, err := client.RPCClient().Statement(context.TODO(), &StatementRequest{
								KID: kida,
								Seq: int32(seq),
							})
							if err != nil {
						...
						resp, err := client.RPCClient().Sigchain(context.TODO(), &SigchainRequest{
							KID: kida,
						})
						if err != nil {
							return err
					...
					Subcommands: []cli.Command{
						{
							...
							Action: func(c *cli.Context) error {
								...
								resp, err := client.RPCClient().StatementCreate(context.TODO(), &StatementCreateRequest{
									KID:   c.String("kid"),
									Data:  b,
									Local: c.Bool("local"),
								})
						...
						},
						{
							...
							Action: func(c *cli.Context) error {
								...
								resp, err := client.RPCClient().StatementRevoke(context.TODO(), &StatementRevokeRequest{
									KID:   kid,
									Seq:   int32(c.Int("seq")),
									Local: c.Bool("local"),
								})
